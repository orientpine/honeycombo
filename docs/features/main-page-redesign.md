...
[Hero 통합 블록]
  ...
  - <h1> 헤드라인: "연구자를 위한 AI 기술 커뮤니티" + 그라데이션 액센트 단어(커뮤니티)
...
| 2026-04-17 | Hero 헤드라인을 포지셔닝에 맞춰 변경 — "기술 뉴스 큐레이션" → "연구자를 위한 AI 기술 커뮤니티" (그라데이션 액센트 단어는 "큐레이션" → "커뮤니티"로 이동, primary→accent 주황 계열 유지) |
