...
### 4. 제목 색상 사이트 전체 오렌지 통일

ArticleCard의 제목 색상을 `var(--color-primary)` (오렌지)로 변경하여 홈페이지·기사 목록·필터 결과 모든 곳에서 동일한 제목 색상 사용.

## 관련 파일

| 파일 | 변경 내용 |
|------|----------|
| `src/components/ArticleCard.astro` | `<style is:global>`, 제목 색상 `var(--color-primary)` 통일, 댓글 observer 글로벌 노출 |
...
|------|----------|
| 2026-04-14 | 최초 작성 |
| 2026-04-14 | 제목 색상을 사이트 전체 오렌지로 통일 |
